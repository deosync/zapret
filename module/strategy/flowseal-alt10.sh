...
config="$config --filter-tcp=80,443 --hostlist=$MODPATH/list/list-general.txt" --hostlist-exclude=$MODPATH/list/list-exclude.txt" --ipset-exclude=$MODPATH/list/ipset-exclude.txt" --dpi-desync=hostfakesplit --dpi-desync-repeats=4 --dpi-desync-fooling=ts,md5sig --dpi-desync-hostfakesplit-mod=host=ozon.ru --new"
...
config="$config --filter-tcp=80,443, --ipset=$MODPATH/list/ipset-all.txt" --hostlist-exclude=$MODPATH/list/list-exclude.txt" --ipset-exclude=$MODPATH/list/ipset-exclude.txt" --dpi-desync=hostfakesplit --dpi-desync-repeats=4 --dpi-desync-fooling=ts --dpi-desync-hostfakesplit-mod=host=ozon.ru --new"
