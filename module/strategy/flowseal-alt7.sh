...
config="$config --filter-tcp=80,443 --hostlist=$MODPATH/list/list-general.txt" --hostlist-exclude=$MODPATH/list/list-exclude.txt" --ipset-exclude=$MODPATH/list/ipset-exclude.txt" --dpi-desync=multisplit --dpi-desync-split-seqovl=681 --dpi-desync-split-pos=1 --dpi-desync-split-seqovl-pattern=$MODPATH/fake/tls_clienthello_www_google_com.bin" --new"
...
config="$config --filter-tcp=80,443, --ipset=$MODPATH/list/ipset-all.txt" --hostlist-exclude=$MODPATH/list/list-exclude.txt" --ipset-exclude=$MODPATH/list/ipset-exclude.txt" --dpi-desync=multisplit --dpi-desync-split-seqovl=681 --dpi-desync-split-pos=1 --dpi-desync-split-seqovl-pattern=$MODPATH/fake/tls_clienthello_www_google_com.bin" --new"
