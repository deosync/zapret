...
config="$config --filter-udp= --ipset=$MODPATH/ipset/all.txt --ipset-exclude=$MODPATH/ipset/exclude.txt --dpi-desync=fake --dpi-desync-autottl=2 --dpi-desync-repeats=14 --dpi-desync-any-protocol=1 --dpi-desync-fake-unknown-udp=$MODPATH/fakequic_initial_www_google_com.bin --dpi-desync-cutoff=n3 --new"
